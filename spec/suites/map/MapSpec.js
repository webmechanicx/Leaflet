describe("Map", function () {
	...
	describe('#DOM events', function () {
		...
		it("mouseout is forwared if fired on the original target", function () {
			var mapSpy = sinon.spy(),
				layerSpy = sinon.spy(),
				otherSpy = sinon.spy();
			var layer = new L.Polygon([[1, 2], [3, 4], [5, 6]]).addTo(map);
		...
		it("mouseout is forwared when using a DivIcon", function () {
			var mapSpy = sinon.spy(),
				layerSpy = sinon.spy(),
				icon = L.divIcon({
		...
		it("mouseout is not forwared if relatedTarget is a target's child", function () {
			var mapSpy = sinon.spy(),
				layerSpy = sinon.spy(),
				icon = L.divIcon({
				    html: "<p>this is text in a child element</p>",
		...
		it("mouseout is not forwared if fired on target's child", function () {
			var mapSpy = sinon.spy(),
				layerSpy = sinon.spy(),
				icon = L.divIcon({
				    html: "<p>this is text in a child element</p>",
